...
int vuprintf(PutcFunc_t putc_f, const char* format, va_list args) noexcept;
int uprintf(PutcFunc_t putc_f, const char* format, ...) noexcept __attribute__((format(printf, 2, 3)));
