...
namespace UI
{
	PrintInfo::PrintInfo(lv_obj_t* parent)
		...
		, m_toolTemp(lv_label_create(getRoot()))
		, m_bedTemp(lv_label_create(getRoot()))
		, m_speed(lv_label_create(getRoot()))
		, m_speedMultiplier(lv_label_create(getRoot()))
		, m_flowRate(lv_label_create(getRoot()))
		, m_flowMultiplier(lv_label_create(getRoot()))
		, m_elapsedTime(lv_label_create(getRoot()))
		, m_remainingTime(lv_label_create(getRoot()))
		, m_layer(lv_label_create(getRoot()))
		, m_fanSpeed(lv_label_create(getRoot()))
	...
	PrintInfo::SpeedInfo::SpeedInfo(lv_obj_t* parent)
		...
		, m_speed(lv_label_create(getRoot()))
		, m_speedMultiplier(lv_label_create(getRoot()))
		, m_acceleration(lv_label_create(getRoot()))
		, m_position(lv_label_create(getRoot()))
		, m_z_offset(lv_label_create(getRoot()))
		, m_z_height(lv_label_create(getRoot()))
		, m_layer(lv_label_create(getRoot()))
	{
		UI_LOCK();
