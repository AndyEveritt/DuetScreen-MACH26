...
namespace UI
{
	...
	class LvImageMethodsGen
	{
	  public:
		 ...
		 * @param src       1) pointer to an ::lv_image_dsc_t descriptor (converted by LVGL's image converter) (e.g.
		 * &my_img) or 2) path to an image file (e.g. "S:/dir/img.bin")or 3) a SYMBOL (e.g. LV_SYMBOL_OK)
		 */
		 ...
		 * x, y can be set with value of LV_PCT, lv_image_get_pivot will return the true pixel coordinate of pivot in
		 * this case.
