...
namespace UI
{
    ...
    class LvCanvasMethodsGen : public LvImageMethodsGen<Derived>
    {
      public:
         ...
         */
        void setBuffer(void * buf, int32_t w, int32_t h, lv_color_format_t cf) requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
         ...
         */
        void setPx(int32_t x, int32_t y, lv_color_t color, lv_opa_t opa) requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
         ...
         */
        void setPalette(uint8_t index, lv_color32_t color) requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
            lv_canvas_set_palette(static_cast<Derived*>(this)->getRootPtr(), index, color);
        }

        lv_draw_buf_t * getDrawBuf() const requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
         ...
         */
        lv_color32_t getPx(int32_t x, int32_t y) const requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
         ...
         */
        lv_image_dsc_t * getImage() const requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
         ...
         */
        const void * getBuf() const requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
         ...
         */
        void copyBuf(const lv_area_t * canvas_area, lv_draw_buf_t * dest_buf, const lv_area_t * dest_area) requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
         ...
         */
        void fillBg(lv_color_t color, lv_opa_t opa) requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
         ...
         */
        void initLayer(lv_layer_t * layer) requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
         ...
         */
        void finishLayer(lv_layer_t * layer) requires HasGetRootPtr<Derived>
        {
            UI_LOCK();
